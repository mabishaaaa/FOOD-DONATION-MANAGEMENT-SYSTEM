...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['signup'])) {
        ...
        // Handle specific user type fields
        $userID = $conn->insert_id; // Get the UserID of the inserted user
        if ($userType == 'donor') {
    ...
    <div class="container" id="signup" style="display: none;">
        ...
        <form method="post" action="">
            ...
            <div id="volunteerFields" class="user-type-specific">
                ...
                <!-- <div class="input-group">
                    <i class="fa-solid fa-house"></i>
                    <input type="text" name="houseNumber" id="houseNumberVolunteer" placeholder="House number" required>
                    <label for="houseNumberVolunteer">House number</label>
                </div>
                <div class="input-group">
                    <i class="fa-solid fa-road"></i>
                    <input type="text" name="roadNo" id="roadNoVolunteer" placeholder="Road number" required>
                    <label for="roadNoVolunteer">Road number</label>
                </div> -->
            </div>
