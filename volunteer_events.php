            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($donorResult->num_rows > 0) {
                    while ($donor = $donorResult->fetch_assoc()) {
                        echo "<div><strong>Name:</strong> " . htmlspecialchars($donor['Name']) . " <br> <strong>Phone:</strong> " . htmlspecialchars($donor['Phone']) . "</div>";
                ...
                if ($supervisorResult->num_rows > 0) {
                    while ($supervisor = $supervisorResult->fetch_assoc()) {
                         echo "<div><strong>Name:</strong> " . htmlspecialchars($supervisor['Name']) . " <br> <strong>Phone:</strong> " . htmlspecialchars($supervisor['Phone']) . "</div>";
                    }
                } else {
